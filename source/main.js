...
/*
    ...
    2. Написать слэш команду для выдачи роли после нажатия кнопки.
    3. Создать файл после запуска которого, бот пишет сообщение в канале (например: Ограниченный по времени конкурс. 
